...
<template>
    ...
    <div class="h-screen inset-0 flex items-center justify-center dark:bg-black">
        ...
        <div class="flex-col">
            <div class="bg-slate-50 p-7 rounded shadow-lg dark:bg-gray-800">
                <div>
                    ...
                    <div v-else-if="englishs.length != 0">
                        ...
                        <div v-for="english in englishs" :key="english._id">
                            ...
                            <p class="text-gray-500 font-medium divide-y">{{ english.russian }}</p>
                           
                            <p @click="blurChoice" class="cursor-pointer mt-1 dark: text-white" :class="{ 'blur-sm': isBlur}">
                                {{ english.englishtext }}
                            </p>
                            <div class="mt-2">
                                <input type="text" v-model="translate" placeholder="Перевод" class="p-2 rounded">
                            </div>
