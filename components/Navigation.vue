<template>
    ...
    <div
        class="fixed bottom-0 left-0 z-50 w-full h-16 bg-purple-500 border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        <div class="flex justify-center h-full max-w-lg  mx-auto font-medium">
            ...
            <NuxtLink to="/post/all"
                ...
                <span
                    class="text-sm text-white dark:text-gray-400 dark:group-hover:text-blue-500">
                    All posts
                </span>
            </NuxtLink>


            <div class="inline-flex flex-col items-center justify-center px-5 hover:bg-purple-400">
                <Test />
                <!-- <span
                    class="text-sm text-white dark:text-gray-400 dark:group-hover:text-blue-500">
                    Режим
